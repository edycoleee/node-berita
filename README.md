...
1. Paham middleware dasar (logger + auth).
2. Paham auth berbasis session untuk web.
3. Paham auth berbasis JWT untuk API.
4. Paham role access (`superadmin` dan `user`).
5. Bisa testing manual (REST Client) dan testing otomatis (unit test).
